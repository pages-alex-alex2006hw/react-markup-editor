...
var MarkupEditor = React.createClass({
    ...
    onFocusChanged: function(editorState, isFocused) {
        var state = this.props.editorState;

        var newFocusedEditor = isFocused? editorState : state.getEditorState();
        ...
        state = MarkupEditorState.updateFocusedEditorState(state, newFocusedEditor);
    ...
    onChange: function(editorState) {
        ...
        if (wasFocused) {
            state = MarkupEditorState.updateFocusedEditorState(state, editorState);
        }
